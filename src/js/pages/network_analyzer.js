            ...
            el.innerHTML = `
                <div class="fade-in-up" style="width: 100%; height: 100%; display: flex; flex-direction: column; gap: 2rem;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            <h1 class="text-title" style="font-size: 2.2rem; color: var(--md-primary); margin-bottom: 0.2rem; letter-spacing: -0.02em;">Diagnostica P2P</h1>
                            <p class="text-body" style="color: var(--md-on-surface-variant); font-size: 1.05rem;">Analisi approfondita della rete, firewall e stato sincronizzazione.</p>
                        </div>
