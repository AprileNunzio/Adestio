...
const activeSockets = new Map(); // key: `${ip}:${port}`, value: ws
...
function connectToPeer(ip, port, targetNodeId) {
    return new Promise((resolve, reject) => {
        ...
        ws.on('open', () => {
            ...
            // Registriamo l'handler per i messaggi in arrivo su questo socket (FONDAMENTALE per ricevere le risposte!)
            try {
...
function handleIncomingMessage(ws, messageStr, handlers) {
    try {
        ...
        // È una risposta a una nostra richiesta?
